...
const Harret = {
  ...
  "personality": "Determinado en la misión de restaurar El Olivo. Ha atravesado décadas de pérdidas y sigue adelante con los pocos vínculos que le quedan.",
  "ideals": [
  ...
  "flaws": [],
  "motivations": "Encontrar la cura del Olivo, débilitado por la maldición demoníaca, y no dejar que el sacrificio de sus compañeros haya sido en vano.",
  "relationships": [
    {
      "name": "Juan Black",
      "description": "Dracónico blanco rescatado de un ataque de demonios y otros dracónico. Comparten objetivos similares y viajan juntos."
    },
    {
      "name": "Compañeros de la expedición",
      "description": "Nueve elfos de élite al partir. Perdidas sucesivas ante demonios, no-muertos y un archidemonio. Los ultimos cuatro murieron salvándole la vida."
    },
    {
      "name": "Thalorin Nairel",
      "description": "Primo de la Casa Nairel. Crecieron juntos en el mismo bosque y más tarde se reencuentran en la misión de salvar el Gran Árbol."
    }
  ],
  "importantEvents": [
    {
      "title": "La hecatombe del Olivo",
      "description": "Diez años de guerra. Bosque devastado; el árbol sobrevive débilitado y maldito."
    },
    {
      "title": "Partida de los voluntarios",
      "description": "A los 109 años sale con nueve elfos de élite a buscar una cura."
    },
    {
      "title": "Perdidas en el camino",
      "description": "Año 15: dos caídos. Año 35: tres mas en una mazmorra; pergaminos que ayudan solo un poco. A los 180: los ultimos cuatro mueren contra un archidemonio."
    },
    {
