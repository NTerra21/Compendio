...
const Kana = {
  ...
  "motivations": "Descubrir hasta dónde puede llevar su llama. Ya no busca una única respuesta sobre quien es antes de caminar: primero camina, y después descubre en que termina convirtiendose.",
  "relationships": [
    {
      "name": "Efreeti",
      "description": "Compañero vinculado a la lámpara. Al principio, intercambio de conocimientos por ayuda. Puede ser arrogante e insoportable; ella, igual de terca. No siempre se llevan bien, pero su presencia se volvió cotidiana y esperada."
    }
  ],
  "importantEvents": [
    {
    ...
    },
    {
      ...
      "description": "Años de teoría sin resultados al copiar magia ajena. Trabajo explorando y buscando objetos olvidados."
    },
    {
      "title": "Encuentro con Efreeti",
      "description": "Hallazgo de la lámpara en una habitación intacta. El la obligo a escuchar la llama que ya llevaba dentro."
    },
    {
